...
function ShowDemoWindow(p_open) {
    ...
    if (ImGui.CollapsingHeader("Configuration")) {
        ...
        if (ImGui.TreeNode("Configuration##2")) {
            ...
            ImGui.Text("Also see Style.Util for rendering options.");
            ImGui.TreePop();
            ImGui.Separator();
        }
...
function ShowDemoWindowWidgets() {
    ...
    if (ImGui.TreeNode("Selectables")) {
        ...
        IMGUI_DEMO_MARKER("Widgets/Selectables/Util more text into the same line");
        if (ImGui.TreeNode("Util more text into the same line")) {
...
//-----------------------------------------------------------------------------
// [SECTION] Example App: Custom Util using ImDrawList API / ShowExampleAppCustomRendering()
//-----------------------------------------------------------------------------
...
function ShowExampleAppCustomRendering(p_open) {
    ...
    IMGUI_DEMO_MARKER("Examples/Custom Util");
